...
import { girzekorn } from 'client/assets/img/girzekorn'
import { kachnova } from 'client/assets/img/kachnova'
import { kosmachev } from 'client/assets/img/kosmachev'
import { kutovaya } from 'client/assets/img/kutovaya'
import { kuzenkina } from 'client/assets/img/kuzenkina'
import { lisicina } from 'client/assets/img/lisicina'
import { malkova } from 'client/assets/img/malkova'
import { patuev } from 'client/assets/img/patuev'
import { poshnagov } from 'client/assets/img/poshnagov'
import { shevchenko } from 'client/assets/img/shevchenko'
import { terekhov } from 'client/assets/img/terekhov'
import { vetrov } from 'client/assets/img/vetrov'
import { vinogradov } from 'client/assets/img/vinogradov'
import { vladimirov } from 'client/assets/img/vladimirov'
import { volkova } from 'client/assets/img/volkova'
import { zharkov } from 'client/assets/img/zharkov'
...
const data = [
  ...
  },
  {
    ...
    skills: {
      label: 'Навыки',
      value: [
        { category: 'Языки', value: 'Английский - средний, Итальянский, Французский - начальный' },
        {
          category: 'Виды спорта',
          value:
